...
% theta1=[ones(input_layer_size+1,1) Theta1];
    X=[ones(m,1) X];
    z2=X*Theta1';
    a2=sigmoid(z2);
    a2=[ones(m,1) a2];
    z3=a2*Theta2';
    h=sigmoid(z3); % H theta
...
Lr=(lambda/(2*m))*(sum(sum(regTheta1.^2))+sum(sum(regTheta2.^2))); %regularized term

J=J+Lr; % cost function
...
for t=1:m
    ...
    % Step 4
	del2 = del2(2:end); % skipping sigma2(0) (25*1)
